...
class _HealthViewState extends State<HealthView> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future:FirebaseFirestore.instance.collection('healthrecord add').where("StudentId",isEqualTo:Stid).where("Teacherid",isEqualTo: Id).get(),
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              "Height",
                              style:
                              GoogleFonts.inriaSerif(fontSize: 20, height: 2),
                            ),
                            Text(
                              "Weight",
                              style:
