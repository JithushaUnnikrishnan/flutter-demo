    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>TeacherChildprofile()));
        ...
        child: Column(
          ...
          Center(
            child: InkWell(onTap: (){
              ...
              child: Center(child: Text('Daily Task',style: GoogleFonts.inriaSerif(color: Colors.white,fontSize:19),)),
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),gradient: LinearGradient(
                ...
                boxShadow: [BoxShadow(color: Colors.grey ,offset: Offset(0, 4),spreadRadius: 2,blurRadius: 4)]),
                      ),
            ),
          ),
            ...
            Center(
              child: InkWell(onTap: (){
                ...
                child: Container(
                  height: MediaQuery.of(context).size.height*.14,width: MediaQuery.of(context).size.width*.41,
                  child: Center(child: Text('Health Record',style: GoogleFonts.inriaSerif(color: Colors.white,fontSize:19),)),
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),gradient: LinearGradient(
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                    colors: [
